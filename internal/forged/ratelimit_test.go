...
func TestDefaultRateLimitsExist(t *testing.T) {
	expectedMethods := []string{
		...
		"/forged.v1.ForgedService/StartLoopRunner",
		"/forged.v1.ForgedService/StopLoopRunner",
		"/forged.v1.ForgedService/GetLoopRunner",
		"/forged.v1.ForgedService/ListLoopRunners",
