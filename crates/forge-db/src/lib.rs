...
mod tests {
    ...
    fn migration_001_embedded_sql_matches_go_files() {
        ...
        let up = include_str!(concat!(
            ...
            "/../../old/go/internal/db/migrations/001_initial_schema.up.sql"
        ));
        let down = include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../old/go/internal/db/migrations/001_initial_schema.down.sql"
        ));
    ...
    fn migration_006_embedded_sql_matches_go_files() {
        ...
        let up = include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../old/go/internal/db/migrations/006_mail_and_file_locks.up.sql"
        ));
        let down = include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../old/go/internal/db/migrations/006_mail_and_file_locks.down.sql"
        ));
    ...
    fn migration_002_embedded_sql_matches_go_files() {
        ...
        let up = include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../old/go/internal/db/migrations/002_node_connection_prefs.up.sql"
        ));
        let down = include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../old/go/internal/db/migrations/002_node_connection_prefs.down.sql"
        ));
    ...
    fn migration_005_embedded_sql_matches_go_files() {
        ...
        let up = include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../old/go/internal/db/migrations/005_port_allocations.up.sql"
        ));
        let down = include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../old/go/internal/db/migrations/005_port_allocations.down.sql"
        ));
    ...
    fn migration_003_embedded_sql_matches_go_files() {
        ...
        let up = include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../old/go/internal/db/migrations/003_queue_item_attempts.up.sql"
        ));
        let down = include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../old/go/internal/db/migrations/003_queue_item_attempts.down.sql"
        ));
    ...
    fn migration_004_embedded_sql_matches_go_files() {
        ...
        let up = include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../old/go/internal/db/migrations/004_usage_history.up.sql"
        ));
        let down = include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../old/go/internal/db/migrations/004_usage_history.down.sql"
        ));
