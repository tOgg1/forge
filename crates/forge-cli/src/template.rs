...
fn load_builtin_templates() -> Result<Vec<Template>, String> {
    let builtins = [
        (
            "commit",
            include_str!("../../../old/go/internal/templates/builtin/commit.yaml"),
        ),
        (
            "continue",
            include_str!("../../../old/go/internal/templates/builtin/continue.yaml"),
        ),
        (
            "explain",
            include_str!("../../../old/go/internal/templates/builtin/explain.yaml"),
        ),
        (
            "review",
            include_str!("../../../old/go/internal/templates/builtin/review.yaml"),
        ),
        (
            "test",
            include_str!("../../../old/go/internal/templates/builtin/test.yaml"),
        ),
    ];
