...
fn builtin_skill_files() -> Vec<(&'static str, &'static [u8])> {
    vec![
        (
            ...
            include_bytes!("../../../old/go/internal/skills/builtin/agent-communication/SKILL.md"),
        ),
        (
            "agent-communication/references/fmail-quickref.md",
            include_bytes!(
                "../../../old/go/internal/skills/builtin/agent-communication/references/fmail-quickref.md"
            ),
        ),
        (
            "issue-tracking/SKILL.md",
            include_bytes!("../../../old/go/internal/skills/builtin/issue-tracking/SKILL.md"),
        ),
        (
            "issue-tracking/references/tk-quickref.md",
            include_bytes!(
                "../../../old/go/internal/skills/builtin/issue-tracking/references/tk-quickref.md"
            ),
        ),
        (
            "session-protocol/SKILL.md",
            include_bytes!("../../../old/go/internal/skills/builtin/session-protocol/SKILL.md"),
        ),
        (
            "session-protocol/references/end-session-checklist.md",
            include_bytes!(
                "../../../old/go/internal/skills/builtin/session-protocol/references/end-session-checklist.md"
            ),
        ),
        (
            "workflow-pattern/SKILL.md",
            include_bytes!("../../../old/go/internal/skills/builtin/workflow-pattern/SKILL.md"),
        ),
    ]
}
