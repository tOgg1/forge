...
- Install git hooks: `bd hooks install` (ensures DB and JSONL consistency)
...
- OK: Use bd for ALL task tracking
- OK: Always use `--json` flag for programmatic use
- OK: Run `bd sync` at end of sessions
- OK: Run `bd <cmd> --help` to discover available flags
- NO: Do NOT create markdown TODO lists
- NO: Do NOT commit `.beads/beads.db` (JSONL only)
