-- Migration: 009_loop_limits (DOWN)
-- Description: Remove max iteration/runtime limits from loops
-- Created: 2026-01-08

DROP INDEX IF EXISTS idx_loops_short_id;

-- SQLite does not support DROP COLUMN; rebuild the table without max limits.
